...
var res1 = NelderMeadSimplex.regress(cs1, 1e-7, 200, fun1); // x = 3.0, y = 2.0, "Converged", 55, error = -7.0
...
var res2 = NelderMeadSimplex.regress(cs2, 1e-12, 200, fun2); // x = -0.065051, y = 0.9778440, "Converged", 160, error = -0.0956595
